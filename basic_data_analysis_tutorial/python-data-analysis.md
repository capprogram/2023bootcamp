...
Save your final plot (with green stars and red plus signs overplotted) to a file called tutorialplot_yournamehere.jpg (or tutorialplot_yournamehere.jpeg). Your OS may default to another image save type; use the menu to choose .jpg or .jpeg instead. Keep a folder in your user directory with your final efforts on this and other tutorials.
